...
export default class Contenido extends Component {
  render() {
    const contenidoContainer = {
        background: this.props.payload.color,
    ...
    //   };
    return (
      // <div className="contenido" style={divStyle}>
      <div className="contenidoContainer" style={contenidoContainer}>
        <div className="contenido">
          <img
            ...
            alt="character"
          />
          <div className="contenidoText">
            <p>{this.props.payload.personaje}</p>
